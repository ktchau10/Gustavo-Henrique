...
switch ($action) {
    case 'add':
        ...
        if (!empty($_POST['nova_categoria'])) {
            $categoria = ucfirst(strtolower($_POST['nova_categoria']));
    ...
    case 'add_variation':
        $produto_id = (int)$_POST['produto_id'];
        $cor = ucfirst(strtolower($_POST['cor']));
        $tamanho = ucfirst(strtolower($_POST['tamanho']));
    ...
    case 'update_variations':
        ...
        foreach ($variacoes as $id => $data) {
            $id = (int)$id;
            $cor = ucfirst(strtolower($data['cor']));
            $tamanho = ucfirst(strtolower($data['tamanho']));
