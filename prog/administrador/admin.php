    ...
    <div class="admin-page-container">
        <aside class="admin-sidebar">
            ...
            <ul class="admin-sidebar__nav">
                ...
                <li class="<?php echo (in_array($view, ['produtos', 'add_produto', 'edit_produto', 'edit_variation'])) ? 'active' : ''; ?>"><a href="admin.php?view=produtos"><i class='bx bxs-t-shirt'></i> Produtos</a></li>
                <li class="<?php echo (in_array($view, ['produtos', 'add_produto', 'edit_produto', 'edit_variation'])) ? 'active' : ''; ?>"><a href="admin.php?view=produtos"><i class='bx bx-box'></i> Estoque</a></li>
            ...
            <?php 
                ...
                switch ($view) {
                    ...
                    case 'edit_produto':
                        ...
                        break;
                    case 'edit_variation':
                        include 'views/admin_view_edit_variation.php';
                        break;
                    case 'clientes':
