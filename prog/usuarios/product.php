...
<head>
    ...
    <title><?php echo htmlspecialchars(ucfirst(strtolower($produto['nome']))); ?> - Nossa Loja</title>
...
<body>
        ...
        <main class="main-content">
            <div class="product-detail-container">
                <div class="product-image-main">
                    <img src="../imagens/<?php echo htmlspecialchars($produto['imagem_url']); ?>" alt="<?php echo htmlspecialchars(ucfirst(strtolower($produto['nome']))); ?>">
                </div>
                <div class="product-details-info">
                    <h1><?php echo htmlspecialchars(ucfirst(strtolower($produto['nome']))); ?></h1>
                    ...
                    <form action="cart_handler.php" method="POST" class="product-options-form">
                        ...
                        <div class="form-group">
                            ...
                            <select name="cor" id="cor" class="form-control" required>
                                <?php foreach ($cores_disponiveis as $cor): ?>
                                    <option value="<?php echo htmlspecialchars($cor); ?>"><?php echo htmlspecialchars(ucfirst(strtolower($cor))); ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select name="tamanho" id="tamanho" class="form-control" required>
                                <?php foreach ($tamanhos_disponiveis as $tamanho): ?>
                                    <option value="<?php echo htmlspecialchars($tamanho); ?>"><?php echo htmlspecialchars(ucfirst(strtolower($tamanho))); ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" id="quantidade" name="quantidade" class="form-control" value="1" min="1" max="10">
                        </div>
    ...
    <div class="side-cart" id="side-cart">
        ...
        <div class="cart__body">
            ...
            ?>
                <div class="cart-item">
                    <img src="../imagens/<?php echo htmlspecialchars($item['imagem']); ?>" alt="<?php echo htmlspecialchars(ucfirst(strtolower($item['nome']))); ?>" class="cart-item__image">
                    <div class="cart-item__info">
                        <p class="cart-item__name"><?php echo htmlspecialchars(ucfirst(strtolower($item['nome']))); ?></p>
                        <small class="cart-item__details"><?php echo htmlspecialchars(ucfirst(strtolower($item['cor']))); ?> / <?php echo htmlspecialchars(ucfirst(strtolower($item['tamanho']))); ?></small>
