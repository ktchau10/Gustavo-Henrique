...
<body>
    ...
    <header class="header">
        ...
        <div class="header__nav">
            ...
            <a href="../login/logout.php" class="header__logout"><i class='bx bx-log-out'></i> Sair</a>
        </div>
    </header>
                    ...
                    <?php while($row = mysqli_fetch_assoc($result_produtos)): ?>
                        <div class="product-card">
                            <div class="product-card__image-box">
                                <img src="../imagens/<?php echo htmlspecialchars($row['imagem_url']); ?>" alt="<?php echo htmlspecialchars(ucfirst(strtolower($row['nome']))); ?>">
                            </div>
                            <div class="product-card__info">
                                <h2 class="product-card__name"><?php echo htmlspecialchars(ucfirst(strtolower($row['nome']))); ?></h2>
